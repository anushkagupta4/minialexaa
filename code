...
def run_alexa():
    ...
    try:
        ...
        if 'hello' in command:
            ...
            print('i can play songs on yoututbe, tell you a joke, search on wikipedia, tell you date and time,find your location,locate area on map, open different websites on google. how may i help you??')
            engine_talk('i can play songs on yoututbe, tell you a joke, search on wikipedia, tell you date and time,find your location,locate area on map, open different websites on google. how may i help you??')
